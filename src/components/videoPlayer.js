...
// import top_vignette from 'images/top-vignette.png';
// import back from 'images/back.png';
// import volume from 'images/volume.png';
// import expand from 'images/expand.png';
// import shrink from 'images/shrink.png';
// import bottom_vignette from 'images/bottom-vignette.png';
...
//      */
//     calculateTime(keyTimer) {

//         if (this.state.showTimeRemaining) {
//             if (keyTimer == "UP") {
//                 const time = 0 + this.state.currentTime;
//                 return `${this.formatTime(time)}`;
//             } else if (keyTimer = "DOWN") {
...
//             ]}>
//                 <ImageBackground
//                     source={this.props.disableVignette ? null : top_vignette}
...
//                 >
//                     <Image style={styles.volume.icon} source={volume} />
//                 </View>
//             </View>
//         );
//     }
...
//         let source = this.state.isFullscreen === true ? shrink : expand;
//         return this.renderControl(
//             <Image source={source} />,
//             this.methods.toggleFullscreen,
...
//         const timerUpControl = this.props.disableTimer ? this.renderNullControl() : this.renderTimer("UP");
//         const timerDownControl = this.props.disableTimer ? this.renderNullControl() : this.renderTimer("DOWN");
...
//             ]}>
//                 <ImageBackground
//                     source={this.props.disableVignette ? null : bottom_vignette}
//                     style={[styles.controls.column]}
//                     imageStyle={[styles.controls.vignette]}>
//                     <SafeAreaView
...
//         return this.renderControl(
//             <View style={styles.controls.viewPlayPause}>
//                 <Image source={source} />
//             </View>,
...
//      * Show our timer.
//      */
//     renderTimer(keyTimer) {

//         return this.renderControl(
//             <Text style={styles.controls.timerText}>
//                 {this.calculateTime(keyTimer)}
//             </Text>,
...
//                     <Animated.Image source={loader_icon} style={[
//                         styles.loader.icon,
//                         {
//                             transform: [
//                                 {
...
//             );
//         }
//         return this.renderCenterControls();
//     }
...
//                     <Image source={error_icon} style={styles.error.icon} />
...
//         return (
//             <TouchableWithoutFeedback
//                 onPress={onPressVideo ? onPressVideo : this.events.onScreenTouch}
