...
import {
    ...
    Pressable, findNodeHandle, ImageBackground, Button
} from 'react-native';
    ...
    renderContentForChooseImg() {
        ...
        return (
            <View style={styleContainerFroImg} >
                ...
                <Hr color={Colors.COLOR_GREY_LIGHT} width={1} style={{ opacity: 1 }} />
                <Pressable
                    android_ripple={{
                        color: Colors.COLOR_WHITE,
                        borderless: false,
                    ...
                    <Text style={[commonStyles.text, { marginLeft: 0, marginBottom: Constants.MARGIN }, styleItemRow]} >{localizes("image")}</Text>
                </Pressable>
            </View>
        )
    }
                ...
                <View style={[{
                    ...
                    <TouchableOpacity block
                        ...
                        onPress={
                            () => { onPressBtnPositive() }}>
                        <Text
                            style={[commonStyles.text, { color: Colors.COLOR_BUTTON_LOGIN_GG }, styleTextBtnTwo]} >{textBtnTwo.toUpperCase()}</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
