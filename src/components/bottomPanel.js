...
export default class BottomPanel extends Component {
    ...
    onSwipeUp() {
        if (!this.expanded) {
            ...
            this.image.setNativeProps({
                ...Platform.OS === 'ios' ? { source: [Image.resolveAssetSource(this.icons.down)] } :
                    { src: [Image.resolveAssetSource(this.icons.down)] }
            })
    ...
    onSwipeDown() {
        if (this.expanded) {
            ...
            this.image.setNativeProps({
                ...Platform.OS === 'ios' ? { source: [Image.resolveAssetSource(this.icons.up)] } :
                    { src: [Image.resolveAssetSource(this.icons.up)] }
            })
            this.expanded = !this.expanded
            // this.setState({expanded: !this.state.expanded})
