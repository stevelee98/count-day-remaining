...
export class EventHistoryDetail extends BaseView {
    constructor(props) {
        super(props)
        this.state = {
            user: null,
    ...
    getTimeAlert = () => {
        let now = new Date();
        if (this.event) {
            let createdTime = new Date(this.event.createdAt);
                        ...
                        return (
                            ...
                            >
                                <View style={{ padding: Constants.PADDING_LARGE }}  >
                                    <Text style={{ ...commonStyles.text400, color: 'red' }}>{item.name}</Text>
                                </View>
                            </MenuOption>
                        )
                    })}
        ...
        return (
            <View>
                ...
                <View style={{ position: 'absolute', bottom: 32, left: 16 }}>
                    <Text style={{ ...commonStyles.text400, color: Colors.COLOR_WHITE, fontSize: Fonts.FONT_SIZE_LARGE }}>Sự kiện đã kết thúc</Text>
                    {/* <Text style={{
                        ...Fonts.FONT_600,
                ...
                <Root>
                    <Content
                        ...
                        <View style={{
                            ...
                            <Text style={{ ...commonStyles.text500, marginHorizontal: Constants.MARGIN_X_LARGE }}>Đã đếm ngược
                                <Text style={{
                                    ...commonStyles.text,
                                    fontSize: 24,
                                    ...Fonts.FONT_600
                            ...
                            <Text style={[styles.txtTimeTypeList, { color: Colors.COLOR_TEXT, marginHorizontal: Constants.MARGIN_X_LARGE }]}>Từ {' '}
                                <Text style={{ fontSize: Fonts.FONT_SIZE_XX_SMALL + 1 }}>
                                    {DateUtil.convertFromFormatToFormat(this.event.createdAt, DateUtil.FORMAT_DATE_TIME_ZONE_T, DateUtil.FORMAT_DATE)}
                                </Text> đến{' '}
                                <Text style={{ fontSize: Fonts.FONT_SIZE_XX_SMALL + 1 }}>{DateUtil.convertFromFormatToFormat(this.event.dayEvent, DateUtil.FORMAT_DATE_SQL, DateUtil.FORMAT_DATE)}</Text>
                            </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(EventHistoryDetail)
