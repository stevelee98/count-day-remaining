...
import friendActionType from 'enum/friendActionType'
import friendRequestType from "enum/friendRequestType";
...
class UserProfileView extends BaseView {
  ...
  */
    uploadImage = (uri) => {
        ...
        let fr = this.storage.ref(`user/${this.state.user.id}/avatar`);
